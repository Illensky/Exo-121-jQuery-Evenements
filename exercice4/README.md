...
- Dans le fichier exercice.js , remplacer "selecteur" par la balise appropriée pour masquer l'élément <input>
lorsque l'utilisateur presse une touche du clavier dans le champ.
